...
public class interviewGrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "SPRING_FRAMEWORK", "BYTE", "WINDOWS_KEYS", "DATE", "TIME", "LPROG", 
			"FREE_TEXT", "SPACE", "COMMENT", "WS", "DECIMAL", "DIGIT", "DAY", "MONTH", 
			"YEAR", "HOURS", "MINUTES"
		};
	}
	...
	public interviewGrammarLexer(CharStream input) {
		super(input);

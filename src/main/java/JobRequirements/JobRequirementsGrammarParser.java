...
public class JobRequirementsGrammarParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, DEGREE=8, FREE_TEXT=9, 
		EXPERIENCEYEARS=10, Comment=11, WS=12;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, null, null, null, null, null, "DEGREE", "FREE_TEXT", 
			"EXPERIENCEYEARS", "Comment", "WS"
		};
	}
	...
	public final FileContext file() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 6270L) != 0) );
			setState(31);
			match(EOF);
			}
		}
	...
	public static class SpecializationNameOptionContext extends ParserRuleContext {
		public List<TerminalNode> FREE_TEXT() { return getTokens(JobRequirementsGrammarParser.FREE_TEXT); }
		public TerminalNode FREE_TEXT(int i) {
			return getToken(JobRequirementsGrammarParser.FREE_TEXT, i);
		}
